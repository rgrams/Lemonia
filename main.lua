...
function love.load()
    ...
    fullscreen = false; title = "Lemonia"
    ...
    require "data.scripts.tiles"; require "data.scripts.timer"; require "data.scripts.camera"; require "data.scripts.audio"
    ...
    -- Scenes
    require "data.scenes.blank"; require "data.scenes.splashScreen"; require "data.scenes.game"; require "data.scenes.deathScreen"; require "data.scenes.menu"
    scenes = {
